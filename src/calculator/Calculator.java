...
public class Calculator {
	...
	public String calculate(String arg1, String operation, String arg2)
			throws DivisionByZeroException,ExceptionVarNum,
			ParseValueException, OperationNotSupportedException, ExceptionVectors {
	...
	private AbstractValue calculate(AbstractValue left, String operation,
			AbstractValue right) throws DivisionByZeroException,ExceptionVarNum, OperationNotSupportedException,ExceptionVectors {
		if (operation.equals("+"))
